package com.thisconnect.server.domain.auth.controller;

import com.thisconnect.server.domain.member.entity.AuthProvider;
import com.thisconnect.server.domain.auth.dto.request.GuestLoginRequest;
import com.thisconnect.server.domain.auth.dto.request.SocialCallbackRequest;
import com.thisconnect.server.domain.auth.dto.response.AuthResponse;
import com.thisconnect.server.domain.auth.service.AuthService;
